              ...
              <table class="table table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{$item->address}}</td>
                    <td>{{$item->price}}</td>
                    <td><img src="assets/cnic/front/{{$item->cnic_front}}" alt=""  onclick="window.open(this.src, '_blank');" style="cursor: pointer;"></td>
                    <td><img src="assets/cnic/back/{{$item->cnic_back}}" alt="" onclick="window.open(this.src, '_blank');" style="cursor: pointer;"></td>
