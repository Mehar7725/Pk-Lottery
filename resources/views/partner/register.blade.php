...
<link rel="stylesheet" href="css/findlottery.css">
...
<div class="container shipping-form">
  <form action="">
   ...
   <input type="file" class=" form-input"  placeholder="Transaction ID">
 </div>
     </div>
     <div class="row">
        <div class="col-md-6">
         <p class=" form-name">Shipping cost</p>
   <input type="number" class=" form-input"  placeholder="Rs.2000" value="Rs.2000" readonly>
        </div>
        <div class="col-md-6">
